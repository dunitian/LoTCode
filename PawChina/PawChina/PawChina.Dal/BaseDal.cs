...
namespace PawChina.Dal
{
    ...
    public abstract partial class BaseDal : IDal.IBaseDal
    {
        ...
        ///// <param name="commandType"></param>
        ///// <returns></returns>
        //public  async Task<SqlMapper.GridReader> QueryMultipleAsync(string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = default(int?), CommandType? commandType = default(CommandType?))
        //{
